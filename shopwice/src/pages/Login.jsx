...
function Login() {
  ...
  return (
    ...
    <div className="min-h-screen w-screen flex items-center justify-center bg-gray-50 p-6">
      ...
      <div className="w-full max-w-md sm:max-w-lg md:max-w-2xl bg-white border border-gray-200 rounded-2xl shadow-xl overflow-hidden">

        {/* Two-column layout on md+, stacked on small screens */}
        <div className="flex flex-col md:flex-row">

          {/* Left column: an image panel visible only on md+ */}
          <div className="hidden md:block md:w-1/2">
            {/* Background image set via inline style to ensure bundlers include asset */}
            <div
          ...
          <div className="p-6 md:w-1/2 bg-white/5">
            {/* Inner white card containing toggle and forms */}
            <div className="bg-white p-4 sm:p-6 rounded-lg">

              {/* Back arrow (top-left) - small UX affordance */}
              <div className="mb-4 flex items-center">
                <a href="#" className="p-1 rounded hover:bg-white/10" aria-label="Back">
              ...
              <div className="mb-4">
                <h1 className="text-2xl sm:text-3xl md:text-4xl font-semibold text-gray-900 mb-1">Welcome to Shopwice</h1>
                <h3 className="text-sm sm:text-md text-gray-600 font-light">Get a great shopping experience with Shopwice</h3>
              </div>
              ...
              {mode === 'signup' ? (
                ...
                <form className="flex flex-col gap-4" action="" onSubmit={(e)=>{e.preventDefault(); /* TODO: handle signup */}}>
                  ...
                  <button className="w-full h-12 cursor-pointer rounded-3xl flex items-center justify-center gap-2 mt-2" style={{backgroundColor: '#1877F2'}}>
